...
class Connect4(object):
    ...
    _game_state = GameState.GAME_CONTINUE
    _board = [[-1]*7 for _ in range(6)]
    _player_lines = {}  # playerindex:{count:list<_Line>}
    ...
    def get_board(self) -> List[List[BoardValue]]:
        ...
        Return Value
        ----
        board : `List[List[BoardValue]]` - the current board state as a 2D array
